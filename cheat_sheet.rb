class CheatSheet 
  attr_accessor :main_menu, :command_line_menu, :vim_menu, :sublime_menu, :main_menu_choice, :command_menu_choice, :search_term, :sublime_menu_choice
  ...
  def initialize
    ...
    @main_menu_choice = 'empty'
    @command_menu_choice = 'empty'
    @search_term = 'empty'
    @sublime_menu_choice = 'empty'
  end
...
new_cheat_sheet = CheatSheet.new
new_cheat_sheet.main_menu()
